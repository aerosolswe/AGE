...
public class Matrix4 {
    ...
    public Vector3 transform(Vector3 r) {
        return new Vector3(m[0][0] * r.getX() + m[0][1] * r.getY() + m[0][2] * r.getZ() + m[0][3],
    ...
    public Matrix4 initOrthoTranslation(float x, float y) {
        m[0][0] = 1;
        m[0][1] = 0;
        m[0][2] = 0;
        m[0][3] = x;
    ...
    public Matrix4 initOrthoRotation(float angle) {
    ...
    public Matrix4 initOrthoScale(float width, float height) {
        m[0][0] = width;
        m[0][1] = 0;
        m[0][2] = 0;
        m[0][3] = 0;
    ...
    public Matrix4 initPerspective(float fov, float width, float height, float zNear, float zFar) {
    ...
    *//*public Matrix4 initOrthographicProjection(float left, float right, float top, float bottom, float near, float far){
